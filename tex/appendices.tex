...
\begin{table}[h!]
	...
	\hline
	Price &  \multicolumn{2}{| p{10cm} |}{1'277.00} \\
	\hline
	\end{tabular}
	\end{center}
...
\begin{table}[h!]
	\begin{center}
	\begin{tabular}{| p{1.16cm} | p{2.16cm} | p{2.16cm} | p{1.76cm} | p{2.06cm} | p{3.66cm} |}
		\hline
		\textbf{Ground truth number} & \textbf{End price (USD)} & \textbf{Task} & \textbf{Percentage} & \textbf{Bonus (USD)} & \textbf{Worker ID} \\
		\hline
