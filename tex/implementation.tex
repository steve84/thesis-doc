...
\begin{table}[h!]
	...
	\begin{tabular}{| p{8.5cm} p{4.5cm} |}
		\hline
		Title: Sony Playstation 4 (black), 1 Controller, New & \includegraphics[scale=0.08]{images/ps4} \\
		\hline
	\end{tabular}
	\end{center}
\end{table}
