...
Another problem are the inconsistencies of the item descriptions. Some auctions contain different declarations of the model in title or description, for example. These inputs were ignored too.
