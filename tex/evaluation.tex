...
\begin{figure}
\centering
\includegraphics[scale=0.4]{images/plots/machine_learning/plot_price_classification_mae.png}
...
\begin{figure}
\centering
\includegraphics[scale=0.45]{images/plots/machine_learning/plot_price_regression_rmse.png}
